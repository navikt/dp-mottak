...
enum class SkjemaType(val skjemakode: String, val tittel: String) {
    ...
    ETTERSENDELSE_TIL_SØKNAD_OM_ETABLERING_AV_EGEN_VIRKSOMHET("NAVe 04-06.08", "Ettersendelse til søknad om dagpenger under etablering av egen virksomhet"),
    ETTERSENDELSE_TIL_SØKNAD_OM_UTDANNING("NAVe 04-06.05", "Ettersendelse til søknad om godkjenning av utdanning med rett til dagpenger"),
