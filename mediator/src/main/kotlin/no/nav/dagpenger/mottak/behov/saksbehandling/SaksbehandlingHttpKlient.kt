...
class SaksbehandlingHttpKlient(
    ...
    override suspend fun hentSisteSakId(ident: String): SakIdResponse {
        sikkerlogg.info { "Henter siste sak id for $ident" }
    ...
    override suspend fun hentSakIdForSøknad(søknadId: UUID): SakIdResponse {
        sikkerlogg.info { "Henter sak id for $søknadId" }
    ...
    override suspend fun skalVarsleOmEttersending(
        ...
        sikkerlogg.info { "Skal sjekke for varsel  om ettersending for søknadId $søknadId og person $ident" }
